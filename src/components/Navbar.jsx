...
const Navbar = () => {
  return (
    <>
        ...
        <div className="flex justify-between font-semibold text-[18px] capitalize items-center text-lg hidden md:flex bg-c1 px-[15vw]">
        ...
        <div className="md:hidden text-[10px] flex  justify-between items-center h-fit font-semibold gap-1 px-4 bg-c1">
